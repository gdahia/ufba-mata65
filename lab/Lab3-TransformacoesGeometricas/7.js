...
function render() {
  var earthIndMat = new THREE.Matrix4();
  ...
  // earth only x rotation
  earth.matrix.copy(earthIndMat);
  earthIndMat.makeRotationX(day);
  earth.applyMatrix(earthIndMat);

  // earth transfs
  earthGroup.matrix.copy(earthMat);

  // rotate on own axis
  earthMat.makeRotationY(day);
  earthGroup.applyMatrix(earthMat);
