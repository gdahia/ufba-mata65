...
function init() {
  ...
  triangleGeometry.faces[1].vertexColors[0] = new THREE.Color(0.0, 0.0, 1.0);
  triangleGeometry.faces[1].vertexColors[1] = new THREE.Color(1.0, 0.0, 1.0);
  triangleGeometry.faces[1].vertexColors[2] = new THREE.Color(1.0, 0.0, 0.0);

  var triangleMaterial = new THREE.MeshBasicMaterial(
      {vertexColors: THREE.VertexColors, wireframe: false});
