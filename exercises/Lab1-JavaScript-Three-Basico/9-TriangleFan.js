...
function init() {
  ...
  for (i = 0; i <= numVertices; i++) {
    ...
    triangleGeometry.faces[i].vertexColors[1] =
        new THREE.Color(0.0, i / numVertices, 1.0 - i / numVertices);
    triangleGeometry.faces[i].vertexColors[2] = new THREE.Color(
        0.0, (i + 1) / numVertices, 1.0 - (i + 1) / numVertices);
  }
